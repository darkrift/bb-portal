...
var (
	...
	ActionExecutionsColumns = []*schema.Column{
		...
		{Name: "execution_platform", Type: field.TypeJSON, Nullable: true},
		{Name: "spawn_total_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_parse_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_network_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_fetch_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_queue_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_setup_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_upload_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_execution_wall_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_process_outputs_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_retry_time_in_ms", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_input_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_input_files", Type: field.TypeInt64, Nullable: true},
		{Name: "spawn_memory_estimate_bytes", Type: field.TypeInt64, Nullable: true},
	...
	ActionExecutionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ActionExecutionsColumns[2], ActionExecutionsColumns[31]},
			},
			{
	...
	BazelInvocationsColumns = []*schema.Column{
		...
		{Name: "action_analytics_state", Type: field.TypeEnum, Enums: []string{"PENDING", "PROCESSING", "COMPLETED", "FAILED"}, Default: "PENDING"},
		{Name: "action_analytics_failure_message", Type: field.TypeString, Nullable: true},
		{Name: "action_analytics_started_at", Type: field.TypeTime, Nullable: true},
		{Name: "action_analytics_completed_at", Type: field.TypeTime, Nullable: true},
		{Name: "action_analytics_result", Type: field.TypeJSON, Nullable: true},
		{Name: "execution_log_status", Type: field.TypeEnum, Enums: []string{"NOT_PROVIDED", "PROCESSED", "FAILED"}, Default: "NOT_PROVIDED"},
		{Name: "execution_log_failure_message", Type: field.TypeString, Nullable: true},
		{Name: "execution_log_action_count", Type: field.TypeInt64, Default: 0},
		{Name: "execution_log_matched_actions", Type: field.TypeInt64, Default: 0},
	...
	BazelInvocationsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{BazelInvocationsColumns[29]},
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "bazelinvocation_action_analytics_state_bep_completed_ended_at",
				Unique:  false,
				Columns: []*schema.Column{BazelInvocationsColumns[6], BazelInvocationsColumns[5], BazelInvocationsColumns[4]},
			},
			{
